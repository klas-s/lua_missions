...
function test_division_is_always_decimal() assert_equal(3.50, 7 / 2) end

function test_there_is_a_table_called_math() assert_equal("table", type(math)) end

function test_some_math_functions()
    assert_equal(8, math.sqrt(64))
    assert_equal(3.0, math.floor(math.pi))
